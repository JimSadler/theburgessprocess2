	...
	<div class="third_wrapper">
		<div class="container">
			<div class="row-fluid">
				...
				<div class="owner span6 alpha omega"><?php printf( __( '%s By %s', 'leadsurf-lite' ), 'Leadsurf', '<a href="'.esc_url('https://sketchthemes.com').'" title="SketchThemes">SketchThemes</a>' ); ?></div>
				<div class="clearfix"></div>
			</div>
		</div>
	</div><!-- third_wrapper --> 
