...
<body <?php body_class(); ?> >
  ...
  <!-- start navbar -->
 <nav class="navbar navbar-default navbar-fixed-top animated fadeInDown" role="navigation">
    <div class="container">
      ...
      <div class="navbar-header">
		...
		<?php  if(get_theme_mod( 'wpf_authority_logo_uploader')) : ?>
			<a class="navbar-brand animated flip duration2" href="<?php echo esc_url( home_url( '/' ) ); ?>">
