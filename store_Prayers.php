            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                <div class="thumbnail animated fadeIn">
                    ...
                    <!-- Flow -->
                     ...
                     <div class="caption">
                         <h4 class="pull-right" data-fsc-item-path="" data-fsc-item-price>$2.99</h4>
                         <h4 data-fsc-item-path="" data-fsc-item-display>Prayers for Real Life</h4>
                         <p>This recording is a collection of prayers for real life. </p>
