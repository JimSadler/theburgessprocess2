  ...
  <div class="container" style="text-align: center;">
    <div id='radio' class="row">
      <div class="col-md-12 editable" id="untitled-region-9">
        ...
        <!-- <h5 role="presentation">There will be no show this week, May 12, 2019.  Please listen to Martha's archived shows on Blog Talk Radio, Facebook Live, and YouTube.  </h5> -->
        <h5 role="presentation">No show on Sunday 08/23/20.</h5>

        <p class="p1">
          <span class="s1"> Martha will be back on 08/30/30   Part 4 of "Creating the Life You Want!" <br><br>

            All Martha's shows are archived on Blog Talk Radio, Facebook Live and YouTube so do please check out past
            shows. We also encourage you to form study groups around these shows to support your journey. And thank you
            for all the support you give us by sharing, following, and liking ours shows! We appreciate it very much!
          </span>
        </p>
        ...
        <a class="btn btn-sm animated-button victoria-three animated flipInX"
          href="https://www.blogtalkradio.com/marthanovak/2019/10/20/real-talk-with-martha-novak" target="_blank">Listen
          to the Show
        </a>
        <a class="btn btn-sm animated-button victoria-three animated flipInX"
          href="https://www.facebook.com/RealTalkwithMartha/" target="_blank">Facebook Live</a>
        <br>
        <br>
        <hr>
        <br>
