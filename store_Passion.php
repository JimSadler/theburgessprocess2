    ...
    <head>
        ...
        <!-- Flow -->
            <script
                ...
                data-storefront="marthaburgessnovak.test.onfastspring.com/popup-Passion">
            </script>
        ...
        <div class="row animated fadeIn" id="shop-thumb">
            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                <div class="thumbnail animated fadeIn">
                    ...
                    <div class="caption">
                         <h4 class="pull-right" data-fsc-item-path="passion" data-fsc-item-price></h4>
                         <h4 data-fsc-item-path="passion" data-fsc-item-display></h4>
                         <p>Passion, what it is, how you go about enjoying it, and how to get more of it.</p>
                         <button data-fsc-item-path-value="passion" data-fsc-action="Add, Checkout">Buy Now</button>
                     </div>
