    ...
    <head>
        ...
        <!-- Fast Sring popup storefront -->
            ...
            <script
                ...
                data-storefront="marthaburgessnovak.test.onfastspring.com/popup-intimacy">
            </script>
        ...
        <div class="row animated fadeIn" id="shop-thumb">
            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                <div class="thumbnail animated fadeIn">
                    ...
                    <div class="caption">
                         <h4 class="pull-right" data-fsc-item-path="intimacy" data-fsc-item-price>$9.99</h4>
                         <h4 data-fsc-item-path="intimacy" data-fsc-item-display>Intimacy</h4>
                         <p>What real intimacy is, relative to Consciousness. </p>
                         <button data-fsc-item-path="intimacy" data-fsc-item-path-value="intimacy" data-fsc-action="Add, Checkout">Buy Now</button>
                     </div>
