            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                <div class="thumbnail animated fadeIn">
                    ...
                    <!-- Flow -->
                     ...
                     <div class="caption">
                         <h4 class="pull-right" data-fsc-item-path="flow" data-fsc-item-price>$9.99</h4>
                         <h4 data-fsc-item-path="flow" data-fsc-item-display>Flow</h4>
                         <p>Flow is essentially about movement and those parts of our lives in which we allow movement experience the most flow.</p>
                         <button data-fsc-item-path="flow" data-fsc-item-path-value="flow" data-fsc-action="Add, Checkout">Buy Now</button>
                     </div>
