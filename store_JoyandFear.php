...
<html lang="en">
    <head>
        ...
        <script
            ...
            data-storefront="marthaburgessnovak.test.onfastspring.com/popup-JoyofFear">
        </script>
            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                <div class="thumbnail animated fadeIn">
                    ...
                    <!-- Flow -->
                     ...
                     <div class="caption">
                         <h4 class="pull-right" data-fsc-item-path="the-joy-and-fear-of-worry" data-fsc-item-price>$2.99</h4>
                         <h4 data-fsc-item-path="the-joy-and-fear-of-worry" data-fsc-item-display>The Joy of Fear and Worry</h4>
                         <p>Exploring the purposes of fear and worry in our daily lives, we see that these things are part of the Dynamic Whole and essential to our growth and well-being. This recording exposes fear and worry for what they are and takes the sting out of them, giving you a new perspective on old conditions that will move out of your life as Consciousness awakens.</p>
                         <button data-fsc-item-path="JoyFearWorry" data-fsc-item-path-value="JoyFearWorry" data-fsc-action="Add, Checkout">Buy Now</button>
                     </div>
