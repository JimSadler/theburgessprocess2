        ...
        <!-- Fast Sring popup storefront -->
         ...
         <!-- True Freedom -->
            <script
                ...
                data-storefront="marthaburgessnovak.test.onfastspring.com/popup-trueFreedom">
            </script>
...
<div class=" page-content container animated fadeIn">
    ...
    <div class="container D-V animated fadeIn">
        ...
        <div class="row animated fadeIn" id="shop-thumb">
            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                <div class="thumbnail animated fadeIn">
                    ...
                    <div class="caption">
                         <h4 class="pull-right" data-fsc-item-path="true-freedom" data-fsc-item-price>$9.99</h4>
                         <h4 data-fsc-item-path="true-freedom" data-fsc-item-display>True Freedom</h4>
                         <p>True freedom is freedom from self imposed tyranny.</p>
                         <button data-fsc-item-path="true-freedom" data-fsc-item-path-value="true-freedom" data-fsc-action="Add, Checkout">Buy Now</button>
                     </div>
        ...
        <!-- <div class="col-lg-4 col-sm-3 col-xs-12">
                <a href="https://plasso.com/s/IWirFGDOeP/The It Series/the_it_series2" id="workBut" class="btn btn-sm animated-button victoria-three animated bounceInRight">Workshops</a>
            </div> -->
